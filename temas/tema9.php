...
<head>
    ...
    <link rel="stylesheet" href="/MecFluidos/Styles/tema9.css">
</head>
<body>
    <header>
        <div class="info">
    ...
    <hr class="line">
    <div class="info-tema">
        <h2>Tema 9: Paredes rectangulares.</h2>
        <br>
        ...
        <div class="formula-container">
            <img class="diagrama-PR" src="/MecFluidos/imagenes/diagrama-paredes-rectangulares.png">
            <img class="fr-formula" src="/MecFluidos/imagenes/formula-fuerza-resultante.png">
        </div>
        <div class="leyenda-formula">
            <ul>
                <li><div class="texto">γ: Peso específico [N/m<sup>3</sup>], [Lb/pies<sup>3</sup>]</div></li>
                <li><div class="texto">d: Altura del fluido [m], [pies]</div></li>
                <li><div class="texto">A: Área de la pared [m<sup>2</sup>], [pies<sup>2</sup>]</div></li>
                <li><div class="texto">F<sub>r</sub>: Fuerza resultante [N], [Lb]</div></li>
            </ul>
        </div>
        <br>
        <h3>Ejemplo:</h3>
        <div class="texto">En la figura anterior el fluido es gasolina (sg=0,68) y la profundidad son 12 pies. la pared tiene 40 pies de largo. Calcular la magnitud de la fuerza resultante sobre la pared y la localización de la presión.</div>
        <br>
        <div class="ejercicio">
            <img class="imagen-procedimiento" src="/MecFluidos/imagenes/ejercicio-PR.png">
        </div>
        <div class="texto"><b>Respuesta:</b> la fuerza resultante vale 122198,4 Lb y el centro de presión se encuentra a 4 pies.</div>
        <br>
        <h3 class="enlaces-interes">Enlaces de Interés</h3>
        <ol>
            <li class="texto"><a href="https://www.goconqr.com/es/diapositiva/5166050/mecanica-de-fluidos-semana-3" class="enlace">https://www.goconqr.com/es/diapositiva/5166050/mecanica-de-fluidos-semana-3</a></li>
            <li class="texto"><a href="https://www.studocu.com/gt/document/universidad-de-san-carlos-de-guatemala/hidraulica/clase-no-18-fuerza-hidrostatica-pared-rectangular/51904418" class="enlace">https://www.studocu.com/gt/document/universidad-de-san-carlos-de-guatemala/hidraulica/clase-no-18-fuerza-hidrostatica-pared-rectangular/51904418</a></li>
            <li class="texto"><a href="https://www.youtube.com/watch?v=xge0TnTHMXE" class="enlace">https://www.youtube.com/watch?v=xge0TnTHMXE</a></li>
        </ol>
    </div>
