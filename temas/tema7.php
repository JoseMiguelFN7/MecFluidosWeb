...
<head>
    ...
    <link rel="stylesheet" href="/MecFluidos/Styles/tema7.css">
</head>
<body>
    <header>
        <div class="info">
    ...
    <hr class="line">
    <div class="info-tema">
        <h2>Tema 7: Barómetro.</h2>
        <br>
        <div class="texto">El barómetro es un dispositivo que se utiliza para medir la presión atmosférica.</div>
        <br>
        <h3>Ejemplo:</h3>
        <div class="texto">¿Qué altura alcanzará el nivel de un tubo de un barómetro si es que en vez de utilizar mercurio para el experimento se utiliza un fluido con una densidad 12,5 g/cm<sup>3</sup>? Se conoce que la presión atmosférica en ese lugar es igual a 0,83 atm. Considerar la gravedad igual a 9,81 m/s<sup>2</sup>.</div>
        <br>
        <div class="ejercicio">
            <img class="imagen-dibujo" src="/MecFluidos/imagenes/ejercicio-barometro1.png">
            <img class="imagen-procedimiento1" src="/MecFluidos/imagenes/ejercicio-barometro2.png">
        </div>
        <div class="texto"><b>Respuesta:</b> el tubo del barómetro alcanzará una altura de 0,69 m.</div>
        <br>
        <h3 class="enlaces-interes">Enlaces de Interés</h3>
        <ol>
            <li class="texto"><a href="https://concepto.de/barometro/" class="enlace">https://concepto.de/barometro/</a></li>
            <li class="texto"><a href="https://www.youtube.com/watch?v=lvtwfTxDaos" class="enlace">https://www.youtube.com/watch?v=lvtwfTxDaos</a></li>
            <li class="texto"><a href="https://es.scribd.com/document/467070651/ejercicios-termodinamica" class="enlace">https://es.scribd.com/document/467070651/ejercicios-termodinamica</a></li>
        </ol>
    </div>
